        ...
        <img src="<?php echo $row['picture']; ?>" id="profile-image">
          <div id="profile-details">
           <br>
            ...
            <hr>
            <div id="change-links">
            <a href="http://localhost/zebodo/components/shopchangepincode.php" id="change-pincode">change pincode </a>
            <a href="http://localhost/zebodo/components/shopchangepassword.php"id="change-password">Change Password</a>
            </div>
