        ...
        if(mysqli_num_rows($result)<=0){
            ?>
                <div id="no-items" align="center">
                    ...
                    <a href="http://localhost/zebodo/components/add_product.php" id="shop-now">Add Product</a>
                </div>
            <?php
                }
                else{
        ...
        <form method="POST">
            ...
            <?php
               echo "<div class='product-spec1'>
                   <a href='http://localhost/zebodo/components/deleteproduct.php?id=$id' id='cancel-book'>Delete product</a>
                    </div>";
                ?>
            </td>
